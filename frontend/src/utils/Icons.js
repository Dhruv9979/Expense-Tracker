...
export const travel = <i className="fa-solid fa-montain-sun"></i>;
...
export const racquet = <i className="fa-solid fa-person-running"></i>;
export const house = <i className="fa-solid fa-house"></i>;
export const hydro = <i className="fa-solid fa-bolt"></i>;
export const car = <i className="fa-solid fa-car"></i>;
export const garbage = <i className="fa-solid fa-trash"></i>;
export const mobile = <i className="fa-solid fa-mobile"></i>;
export const wifi = <i className="fa-solid fa-wifi"></i>;
export const haircut = <i className="fa-solid fa-scissors"></i>;
